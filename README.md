...
**🔍 Project Overview:**
This website showcases a **Real-Time Object Detection system** built with Python. It demonstrates how machine learning and computer vision can identify and track objects from a live webcam or video stream, providing an interactive and visual experience.
...
1. Captures live frames from a **webcam** or video file.
2. Processes frames through a **pre-trained object detection model**.
3. Annotates objects with **bounding boxes** and **labels**.
4. Displays the processed video in **real-time** for immediate feedback.
